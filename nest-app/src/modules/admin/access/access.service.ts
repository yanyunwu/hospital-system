...
export class AccessService {
    ...
    async getRoleList(skip?: number, take?: number, options?: Role): Promise<[Array<Role & { key: number }>, number]> {
    ...
    async getAuthList(skip?: number, take?: number, options?: Auth): Promise<[Array<Auth & { key: number }>, number]> {
    ...
    async addAuth(identification: string, name: string, path: string, status: boolean) {
        const auth = new Auth()
